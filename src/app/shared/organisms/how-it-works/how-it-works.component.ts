...
export class HowItWorksComponent {
  steps = [
    ...
    { icon: 'palette', title: 'Diseñamos juntos', text: 'Te proponemos maderas, acabados y grabados según tu idea.' },
    { icon: 'hammer', title: 'Armamos tu caja', text: 'Preparamos cada caja a mano con los detalles acordados.' },
